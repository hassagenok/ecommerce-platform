...
1. Recommended flow - короткоживущие feature-branch или же прямой пуш в мейн.
...
# local checks:
make check - чистый
git status --short - хранит в себе только один файл в staging area (docs/workflow-decision.md)
A  docs/workflow-decision.md
